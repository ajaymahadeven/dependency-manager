    ...
    <>
      ...
      <div className="mx-auto mt-16 grid max-w-4xl gap-6 md:grid-cols-3">
        ...
        <Link href="/scan/npm" className="group h-full">
          <Card className="hover:bg-accent h-full border-zinc-200 transition-all duration-300 dark:border-zinc-800">
            <CardHeader className="space-y-4">
              <div className="bg-accent flex h-12 w-12 items-center justify-center rounded-full transition-transform duration-300 group-hover:scale-110">
