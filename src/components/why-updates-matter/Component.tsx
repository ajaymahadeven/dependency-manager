...
export default function WhyUpdatesMatterComponent() {
  return (
    <>
      <div className="container mx-auto max-w-7xl p-6">
        ...
        <Card className="mb-8">
          ...
          <CardContent>
            <p className="mb-4">
              ISO 27001 requires organizations to maintain systematic approaches
              to managing sensitive company information. Regular package updates
        ...
        <Alert className="border-blue-200 bg-blue-50">
          ...
          <AlertDescription>
            Investment in proper package management and updates typically costs
            less than 1% of what a major security breach might cost. Regular
            updates prevent costly emergency fixes, reduce downtime, and
